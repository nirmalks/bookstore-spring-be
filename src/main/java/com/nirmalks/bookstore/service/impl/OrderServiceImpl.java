...
import com.nirmalks.bookstore.mapper.OrderMapper;
import com.nirmalks.bookstore.repository.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public OrderResponseDto createOrder(DirectOrderRequest directOrderRequest) {
    ...
    @Override
    public OrderResponseDto createOrder(OrderFromCartRequest orderFromCartRequest) {
